...
KEYWORD_RESPONSES = [
    (['stress','what is stress','define stress','meaning of stress'],
     "Stress is your body's natural response to pressure or demands. Short-term stress can boost performance, but chronic occupational stress leads to burnout, health problems, and reduced productivity. You can ask me about your OSI score, specific subscales, coping strategies, sleep, exercise, or helplines."),
